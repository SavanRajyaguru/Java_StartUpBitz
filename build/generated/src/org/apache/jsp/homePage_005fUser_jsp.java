...
public final class homePage_005fUser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Home Page User</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        \n");
      out.write("        ");
      ...
      out.write("                  <a class=\"nav-link active\" aria-current=\"page\" href=\"Edit_Profile_User.jsp\">Edit Profile</a>\n");
      out.write("                </li>\n");
      out.write("                <li class=\"nav-item\">\n");
      ...
      out.write("        ");
            ...
            try{
                ...
                ResultSet rs = st.executeQuery("select company_name,url,about,investor_name,total_funding,industry,city,country,founded_year from user_ent");
      ...
      out.write("                <div class=\"card shadow bg-light rounded\">\n");
...
out.print(cname);
      ...
      out.write("                                <h6><a href=\"");
out.print(url);
      out.write("\" target=\"_blank\" class=\"card-text\">");
out.print(url);
      out.write("</a></h6>\n");
...
out.print(about);
      out.write("\n");
      out.write("                                </p>\n");
      out.write("                                <h5><p class=\"card-text\"> <b>Investors</b></p></h5>\n");
      out.write("                                <p>\n");
      out.write("                                    ");
out.print(investor);
      out.write("\n");
      ...
      out.write("                                <ul>\n");
      out.write("                                    <li>\n");
      out.write("                                        <p class=\"card-text\"> <b>Total Funding: </b>");
out.print(totalFunding);
      out.write("</p>\n");
      out.write("                                    </li>\n");
      out.write("                                    <li>\n");
      out.write("                                        <p class=\"card-text\"> <b>Industry: </b>");
out.print(industry);
      out.write("</p>\n");
      out.write("                                    </li>\n");
      out.write("                                    <li>\n");
      out.write("                                        <p class=\"card-text\"> <b>City: </b>");
out.print(city);
      out.write("</p>\n");
      out.write("                                    </li>\n");
      out.write("                                    <li>\n");
      out.write("                                        <p class=\"card-text\"> <b>Country: </b>");
out.print(country);
      out.write("</p>\n");
      out.write("                                    </li>\n");
      out.write("                                    <li>\n");
      out.write("                                        <p class=\"card-text\"> <b>Founded Date </b>");
out.print(date);
      out.write("</p>\n");
      out.write("                                    </li> \n");
      out.write("                                </ul>\n");
