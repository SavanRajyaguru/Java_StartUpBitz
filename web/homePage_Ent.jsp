<%-- 
    Document   : homePage_Ent
    Created on : Mar 13, 2022, 1:39:00 AM
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid">
            <h4><a class="navbar-brand" href="homePage_Ent.jsp"><b>StartUpBitz</b></a></h4>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="Edit_Profile_Ent.jsp">Edit Profile</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="About_Ent.jsp">About</a>
                </li>
              </ul>
                <% 
                    try{
                        ...
                        ResultSet rs1 = st2.executeQuery("select verify from user_ent where eid="+session.getAttribute("eid"));
                        rs1.next();
                        if(rs1.getInt(1) == 0)
                                {%>
                                <h4>Status:&nbsp;</h4> <h4 class="card-title" style="color:red;"> Unverify </h4>
                                <%
                                }else{
                                %>
                                <h4>Status:&nbsp;</h4> <h4 class="card-title" style="color:green;"> Verify </h4>
                                <%
                                }
        ...
        <%
            try{
                ...
                ResultSet rs = st.executeQuery("select company_name,url,about,investor_name,total_funding,industry,city,country,founded_year from user_ent where verify = 1");
