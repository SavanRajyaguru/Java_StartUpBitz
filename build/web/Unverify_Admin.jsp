<%-- 
    Document   : Unverify_Admin
    Created on : Mar 19, 2022, 3:19:30 PM
    ...
    <body>
        ...
        <%
            try{
                ...
                int result = st.executeUpdate("update user_ent set verify=0 where eid="+eid);
